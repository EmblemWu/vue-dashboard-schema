...
## Milestone G - Admin Governance

- [x] 新增管理员管理 API（列表/新建/编辑/启停/重置密码）
- [x] 新增管理员管理页面（搜索 + 新建 + 编辑 + 启停 + 重置密码）
- [x] 扩充 demo 数据：内置多管理员账号
- [x] e2e 覆盖 managers 页面链路
- [x] 配置 RBAC：权限接口 + 菜单过滤 + 路由守卫 + 写操作控制
